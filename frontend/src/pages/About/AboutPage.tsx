      ...
      <section className="px-4">
        ...
        <div className="w-full flex justify-between gap-5 items-center flex-col-reverse md:flex-row">
          <p className="text-2xl text-center dark:text-slate-400 max-w-lg">
            ...
            quod molestiae, minima quis repudiandae sint ex eligendi illo
            ratione libero consectetur! Lorem ipsum dolor sit amet consectetur
            adipisicing elit. Sequi, magnam tenetur! Veritatis corrupti
            voluptatum saepe aspernatur.
          </p>
